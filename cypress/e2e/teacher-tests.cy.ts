describe("Teacher Functionality", () => {
  ...
  describe("Class Management", () => {
    ...
    it("Can edit an existing class", () => {
      ...
      cy.get('[data-testid="class-page-loaded"]', { timeout: 10000 }).should('exist');
      ...
      cy.get('textarea[name="description"]').clear().type("This is an updated test class description");
      ...
      cy.contains("This is an updated test class description").should("be.visible");
  
      // Navigate back to dashboard
      cy.visit("/dashboard");
  
      // Wait for the dashboard to load
      cy.get('[data-testid="server-render-complete"]', { timeout: 10000 }).should("exist");
  ...
  //     cy.clerkSignIn({ strategy: "password", identifier: "teacher1@test.com", password: "teacher1" })
  //     cy.visit("/dashboard")
  //   })
  ...
  //   it('Can edit an existing assessment', () => {
  ...
  //   it('Can add a student to a class', () => {
  //     // Test adding a student
  //   })

  //   it('Can remove a student from a class', () => {
